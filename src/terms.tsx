...
export const TERMS = {
  // Nouns — singular
  warehouse: { forklift: "Warehouse", git: "Repository", melo: "Műhely", brainrot: "Repoverse" },
  parcel: { forklift: "Parcel", git: "Commit", melo: "Papír", brainrot: "Canon Event" },
  pallet: { forklift: "Pallet", git: "Branch", melo: "Ág", brainrot: "Aura Line" },
  haul: { forklift: "Haul", git: "Pull request", melo: "Behegesztés", brainrot: "Collab Request" },
  tag: { forklift: "Tag", git: "Tag", melo: "Pecsét", brainrot: "Receipts" },
  bay: { forklift: "Bay", git: "Worktree", melo: "Bódé", brainrot: "Side Quest" },
  inventory: { forklift: "Inventory", git: "Index", melo: "Raktárlista", brainrot: "The Stack" },

  // Nouns — plural / section & tab labels
  pallets: { forklift: "Pallets", git: "Branches", melo: "Ágak", brainrot: "Aura Lines" },
  hauls: { forklift: "Hauls", git: "Pull requests", melo: "Behegesztések", brainrot: "Collab Requests" },
  tags: { forklift: "Tags", git: "Tags", melo: "Pecsétek", brainrot: "Receipts" },
  ...
  blame: { forklift: "Blame", git: "Blame", melo: "Ki a ludas", brainrot: "Snitch Mode" },
  conflicts: { forklift: "Conflicts", git: "Conflicts", melo: "Szopások", brainrot: "Beef" },
  manifest: { forklift: "Manifest", git: "Notes", melo: "Firkák", brainrot: "Paper Trail" },
  ...
  franchise: { forklift: "Franchise", git: "Clone", melo: "Másol", brainrot: "Clone Jutsu" },
